...
subtitle: "Задача о погоне - вариант 56"
...
Через определенный промежуток времени туман рассеивается, и лодка обнаруживается на расстоянии 17.9 км от катера. 
...
n=5.2 #разница в скорости
s=17.9 #расстояние обнаружения
