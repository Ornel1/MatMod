...
date: 23 февраля, 2022, Москва, Россия
...
В начальный момент времени страна $X$ имеет армию численностью 36010 человек, а в распоряжении страны $Y$ армия численностью в 41000 человек.
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.12x(t) - 0.74y(t) + sin(t+1)+2
	\\   
	\frac{dy}{dt}= -0.49x(t) - 0.53y(t) + cos(t+2)+2
 \end{cases}
$$
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.47x(t) - 0.654y(t) + 1.5|sin(2t)|
	\\   
	\frac{dy}{dt}= -0.456x(t)y(t) - 0.39y(t) + 2|cos(t)|
 \end{cases}
$$
