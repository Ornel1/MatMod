...
subtitle: "Модель распространения рекламы - вариант 56"
...
1.	$\frac{dn}{dt} = (0.68 + 0.00009n(t))(N-n(t))$
2.	$\frac{dn}{dt} = (0.00001 + 0.28n(t))(N-n(t))$
3.	$\frac{dn}{dt} = (0.1\sin{5t} + 0.4\cos{3t}n(t))(N-n(t))$

При этом объем аудитории $N = 1505$, в начальный момент о товаре знает 7 человек.
